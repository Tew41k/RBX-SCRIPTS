...
if os.date("*t", os.time()).month == 4 then
	...
	Title.Text = "IYR V"  .. currentVersion
else
	Title.Text = "IYR V"  .. currentVersion
end
do
...
CMDs[#CMDs + 1] = {NAME = 'executor / exec / codeex', DESC = 'In game executor that can execute a LuaU code.'}
...
CMDs[#CMDs + 1] = {NAME = 'mspaint / msp', DESC = 'Opens Mspaint V4'}
...
addcmd("executor", {"exec", "codeex"}, function(args, speaker)
	loadstring(game:HttpGet("https://pastebin.com/raw/QBC9P7As"))()
end)
...
addcmd("mspaint", {"msp"}, function(args, speaker)
	notify('Loading', 'Hold on a sec')
